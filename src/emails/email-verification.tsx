        ...
        <Body className="m-auto font-sans">
          <Container className="mx-auto my-10 max-w-[465px] bg-white p-5">
            ...
            <Text className="text-start text-sm leading-relaxed">
              {"We've"} recieved a email verification with the following code.
              Please enter it where you attempt to authenticate in for {company}
            </Text>
            ...
            <Text className="text-start text-sm leading-relaxed">
              If you {"didn't"} attempt to verify but recieved this email,
              please disregard it. The code will remain active for 5 minutes,
